...
public class Settings : MonoBehaviour
{
    ...
    public void SetMouseSensitivity(float value){
        PlayerCameraMovement playerCameraMovement = FindFirstObjectByType<PlayerCameraMovement>();
        if (playerCameraMovement != null) playerCameraMovement.mouseSense = value;
    }
}
